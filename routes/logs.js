...
/**
 * it_titem revert item and set a log for global update
 */
router.put( '/it_titem/revert/:id', jsonParser,  function( req, res ) {
    var userdata = JSON.parse( req.cookies[ 'userdata' ] );
    request(
        {
...
* it_titem get all the active logs
*/
router.get( '/it_titem/inactive', jsonParser,  function( req, res ) {
    var userdata = JSON.parse( req.cookies[ 'userdata' ] );
    request(
        {
