...
router.get( '/', jsonParser, function( req, res ) {
    ...
    request(
        {
            url : http_helper.get_business_api_uri( userdata.user_data.e_p, 'userlocations/', '' ),
            method : 'GET',
            json : true,
            headers : {
...
router.get( '/:id', jsonParser, function( req, res ) {
    ...
    request(
        {
            url : http_helper.get_business_api_uri( userdata.user_data.e_p, 'userlocations/', req.params.idea ),
            method : 'GET',
            json : true,
            headers : {
                'Authorization' : http_helper.get_basic_auth_w_token( encryption_system.decryptCookie( userdata.auth_data ) )
...
router.put( '/:id', jsonParser, function( req, res ) {
    ...
    request(
        {
            url : http_helper.get_business_api_uri( userdata.user_data.e_p, 'userlocations/', req.params.id ),
            method : 'PUT',
            json : true,
            body : encryption_system.encryptLongJSON( req.body ),
            headers : {
