...
/**
* camaleonadmin list petttion
**/
router.get( '/', jsonParser, function( req, res ) {
    var userdata = JSON.parse( req.cookies[ 'userdata' ] );
    request(
        {
            url : http_helper.get_business_api_uri( userdata.user_data.e_p, 'camaleonadmin/', '' ),
            method : 'GET',
            json : true,
            headers : {
...
/**
* camaleonadmin create pettition
**/
...
/**
* camaleonadmin retrieve pettition
**/
router.get( '/:id', jsonParser, function( req, res ) {
    var userdata = JSON.parse( req.cookies['userdata'] );
    request(
        {
            url : http_helper.get_business_api_uri( userdata.user_data.e_p, 'camaleonadmin/', req.params.id ),
            method : 'GET',
            json : true,
            headers : {
                'Authorization' : http_helper.get_basic_auth_w_token( encryption_system.decryptCookie( userdata.auth_data ) )
...
/**
* camaleonadmin update pettition
**/
...
/**
* camaleonadmin delete pettition
**/
