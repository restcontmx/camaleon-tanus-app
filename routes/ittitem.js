...
/**
* it_titem list petttion
**/
router.get( '/', jsonParser, function( req, res ) {
    var userdata = JSON.parse( req.cookies[ 'userdata' ] );
    request(
        {
            url : http_helper.get_business_api_uri( userdata.user_data.e_p, 'it_titem/', '' ),
            method : 'GET',
            json : true,
            headers : {
...
/**
* it_titem retrieve pettition
**/
router.get( '/:id', jsonParser, function( req, res ) {
    var userdata = JSON.parse( req.cookies['userdata'] );
    request(
        {
            url : http_helper.get_business_api_uri( userdata.user_data.e_p, 'it_titem/', req.params.id ),
            method : 'GET',
            json : true,
            headers : {
                'Authorization' : http_helper.get_basic_auth_w_token( encryption_system.decryptCookie( userdata.auth_data ) )
...
router.get( '/byuser', jsonParser, function( req, res ) {
    ...
    request(
        {
            url : http_helper.get_business_api_uri( userdata.user_data.e_p, 'it_titem/byuser/', '' ),
            method : 'GET',
            json : true,
            headers : {
                'Authorization' : http_helper.get_basic_auth_w_token( encryption_system.decryptCookie( userdata.auth_data ) )
...
router.get( '/stock', jsonParser, function( req, res ) {
    ...
    request(
        {
            url : http_helper.get_business_api_uri( userdata.user_data.e_p, 'it_titem/stock/', '' ),
            method : 'GET',
            json : true,
            headers : {
                'Authorization' : http_helper.get_basic_auth_w_token( encryption_system.decryptCookie( userdata.auth_data ) )
