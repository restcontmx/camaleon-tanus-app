...
router.get( '/', jsonParser, function( req, res ) {
    ...
    request(
        {
            url : http_helper.get_business_api_uri( userdata.user_data.e_p, 'permission/', '' ),
            method : 'GET',
            json : true,
            headers : {
...
router.get( '/:id', jsonParser, function( req, res ) {
    ...
    request(
        {
            url : http_helper.get_business_api_uri( userdata.user_data.e_p, 'permission/', req.params.id ),
            method : 'GET',
            json : true,
            headers : {
                'Authorization' : http_helper.get_basic_auth_w_token( encryption_system.decryptCookie( userdata.auth_data ) )
