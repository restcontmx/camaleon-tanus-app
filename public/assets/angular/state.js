    ...
    .config(['$stateProvider', '$urlRouterProvider',
        function ($stateProvider, $urlRouterProvider) {
            ...
            $stateProvider
                ...
                .state('auth.reports.summary', {
                    page_title: 'Reports - Sales Summary',
                    ncyBreadcrumb: {
                        label: 'Sales Summary'
                    },
                    url: '/sales_summary',
                    templateUrl: 'views/reports/reports.sales.summary.html',
                    resolve: {
                        files: [
                            'uiLoad',
                            function (uiLoad) {
                    ...
                    controller: 'sales-summary-reports-controller'
                })
                .state('auth.reports.sales_detail', {
                    page_title: 'Reports - Sales Detail',
                    ncyBreadcrumb: {
                        label: 'Sales Detail'
                    },
                    url: '/sales_detail',
                    templateUrl: 'views/reports/reports.locations.html',
                    resolve: {
                        files: [
                            'uiLoad',
                            function (uiLoad) {
                    ...
                    controller: 'location-reports-controller'
                })
                .state('auth.reports.centralized', {
                    page_title: 'Reports - Centralized Summary',
                    ncyBreadcrumb: {
                        label: 'Centralized Summary'
                    },
                    url: '/centralized',
                    templateUrl: 'views/reports/reports.centralized.html',
                    resolve: {
                        files: [
                            'uiLoad',
                            function (uiLoad) {
                    ...
                    controller: 'centralized-reports-controller'
                })
                ...
                .state('auth.reports.families', {
                    page_title: 'Reports - Families',
                    url: '/families',
                    templateUrl: 'views/reports/reports.families.html',
                    resolve: {
                        files: [
                            'uiLoad',
                            function (uiLoad) {
                    ...
                    controller: 'family-reports-controller',
                    ncyBreadcrumb: {
                        label: 'Families'
                    }
                })
