		...
		output: function(type, options) {
			...
			if(type == 'datauri') {
				...
				newWindow.document.write(
					'<html><body><center>' +
					'<a title="Download File" style="font-family: \'Verdana\';color: #333;text-decoration: none;font-weight: 600;" download="File.PDF" href="data:application/pdf;base64,' + Base64.encode(buffer) + '">Download File</a>' +
					'</center><br>' +
					'<object width=100% height=100% type="application/pdf" data="data:application/pdf;base64,' + Base64.encode(buffer)  + '">' +
					'<embed type="application/pdf" src="data:application/pdf;base64,' + Base64.encode(buffer)  + '" id="embed_pdf"></embed>' +
					'</object></body></html>');
